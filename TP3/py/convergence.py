...
def bar_plot_convergence(methods,
    ...
    plt.ylabel("Porcentaje de casos en los que el método converge")
    plt.tight_layout()
    plt.yscale(scale)
...
#         LOW, HIGH, FACTORS, None, 100)
# measure_convergence_ratio_growing_diagonal(
#         "gauss_seidel_matrix", DIMENSION, REPETITIONS,
#         LOW, HIGH, FACTORS, None, 100)

for its, factors_to_plot in GS_PLOT_PARAMS:
    # measure_convergence_ratio_growing_diagonal(
    #     "gauss_seidel_sum_method", DIMENSION, REPETITIONS,
    #     LOW, HIGH, factors_to_plot, None, its)
    # measure_convergence_ratio_growing_diagonal(
